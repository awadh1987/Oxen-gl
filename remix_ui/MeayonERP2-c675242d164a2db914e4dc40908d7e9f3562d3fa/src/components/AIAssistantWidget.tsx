    ...
    <>
      ...
      {!isOpen && (
        <motion.div
          ...
          className={`fixed bottom-6 ${isAr ? 'left-6' : 'right-6'} z-50`}
        >
          <button
            id="floating-ai-assistant-button"
            onClick={() => setIsOpen(true)}
            className="group relative flex items-center gap-3 rounded-full border border-orange-300/80 bg-gradient-to-r from-orange-950 via-orange-800 to-purple-900 px-4 py-3 text-white shadow-2xl shadow-orange-950/40 transition-all hover:scale-105 hover:shadow-orange-500/30 active:scale-95"
          ...
          >
            ...
            <div className="relative flex items-center gap-2.5">
              <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-white shadow-inner backdrop-blur-md">
              ...
              <div className="flex flex-col text-right">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-black tracking-wide">
                    {isAr ? 'المساعد الذكي (Gemini AI)' : 'AI Operations Auditor'}
                  </span>
