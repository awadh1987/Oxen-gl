      ...
      <div className="flex flex-col justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-xs sm:flex-row sm:items-center">
        ...
        {canAccessFinancials && (
          <button
            ...
            className="flex items-center gap-2 rounded-2xl bg-orange-600 px-5 py-3 text-xs font-black text-white shadow-md shadow-orange-600/30 transition-all hover:bg-orange-700"
          >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-3xl border border-rose-100 bg-gradient-to-br from-rose-50/70 via-white to-white p-5 shadow-xs">
          ...
          <p className="mt-1 text-[11px] text-slate-500">
            {isAr ? 'مدفوعات الكسارات والناقلين والتشغيل' : 'Crushers, transporters & ops'}
          </p>
        </div>
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-xs lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <option value="Crusher_Settlement">{isAr ? 'مستحقات كسارات' : 'Crushers'}</option>
            <option value="Transporter_Payment">{isAr ? 'مستحقات ناقلين' : 'Transporters'}</option>
                      ...
                      <td className="px-4 py-3.5 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] text-slate-500">
                            {vch.category === 'Crusher_Settlement' ? (isAr ? 'كسارة' : 'Crusher') :
                             vch.category === 'Transporter_Payment' ? (isAr ? 'ناقل' : 'Transporter') :
