...
export const OperationsLogView: React.FC = () => {
  ...
  return (
    <div className="space-y-5" id="operations-log-view" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="grid grid-cols-2 gap-3 rounded-2xl border border-orange-100 bg-gradient-to-r from-orange-50/50 via-amber-50/30 to-neutral-50 p-4 sm:grid-cols-4 2xl:grid-cols-4 shadow-xs">
        <div>
