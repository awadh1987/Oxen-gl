...
class WaslClient {
  ...
  /**
   * Register or update a vehicle with the Elm WASL registry
   */
  ...
  /**
   * Validate a driver's legal eligibility (Iqama/National ID) with WASL
   */
  ...
  /**
   * Send live vehicle telemetry ping (location, speed, heading) to Elm WASL
   */
...
export { WaslClient, waslClient };
export default waslClient;
